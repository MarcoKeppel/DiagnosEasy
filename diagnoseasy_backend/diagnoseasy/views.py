...
def diagnose(patient):
    ...
    data['diabetes'] = get_score(k_diabetic_patients[0], k_diabetic_multipliers, kb_diabetic_patients, kb_diabetic_multipliers)
    data['coronary_heart_disease'] = get_score(k_coronary_heart_disease_patients[0], k_coronary_heart_disease_multipliers, kb_coronary_heart_disease_patients, kb_coronary_heart_disease_multipliers)
